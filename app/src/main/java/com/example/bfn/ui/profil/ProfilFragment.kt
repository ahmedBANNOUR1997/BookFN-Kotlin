...
class ProfilFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        Picasso.get().load("https://bookfanatic.herokuapp.com/uploads/users/${UserSession.img}").into(picture)
        ...
        Picasso.get().load("https://bookfanatic.herokuapp.com/uploads/users/${UserSession.img}").into(full_screen_picture_iv)
